...
<div id="page-content-wrapper">
	...
	<div class="container caixa-conteudo">
		<div class="row">
			<div class="col-lg-12">
				<div class="container">
					<form name="cadastro" method="POST" action="../componentes/pessoa/logica/editar.php?operacao=info&sessionId=<?php echo $num ?>&cpf=<?php echo $cpf?>" enctype="multipart/form-data"> <!-- login.php -->  
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label" for="exampleInputEmail1">Nome</label>
									<input value="<?php echo $nome?>"  class="form-control" id="nome" name="nome" placeholder="Digite o nome (somente letras)" type="text" maxlength="50" minlength="4" pattern="[a*A*-z*Z*]*+" />
								</div> 
							</div>
							<div class="col-md-6">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input disabled value="<?php echo $cpf?>" class="form-control" id="CPF" name="CPF" placeholder="Digite o CPF" type="text" />				  
								</div>				
							</div>
							<div class="col-md-4">
								<div class="form-group">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input value="<?php echo $graduacao?>" class="form-control" id="graduacao" name="graduacao" placeholder="Digite o graduação" type="text" />				  
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
