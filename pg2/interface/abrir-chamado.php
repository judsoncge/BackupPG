...
<div id="page-content-wrapper">
	...
	<div class="container caixa-conteudo">
		<div class="row">
			<div class="col-lg-12">
				<div class="container">
					<form name="cadastro" method="POST" action="../componentes/chamado/logica/cadastrar.php?sessionId=<?php echo $num ?>" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-6">
							...
							<?php $permissao = retorna_permissao($_SESSION['CPF'],'ABRIR_TODOS_CHAMADO',$conexao_com_banco); if($permissao=='sim'){ ?>
