				...
				<div class="container">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="input-group margin-bottom-sm">
									...
									placeholder="Buscar por nome do servidor, nome do mês ou número do ano" 
									id="search"/>
								</div>
							</div>
					...
					<div class="col-md-12 table-responsive" style="overflow: auto; width: 100%; height: 300px;">
						<table class="table table-hover tabela-dados">
							...
							<tbody>
								<?php $lista = retorna_produtividades($conexao_com_banco);
								...
								<tr>
									...
									<td><?php echo $r -> NR_DOCUMENTOS ?></td>
									<td><?php echo $r -> NR_DOCUMENTOS_SEM_SUGESTAO ?></td>
									<td><?php echo $r -> NR_DOCUMENTOS_COM_SUGESTAO ?></td>
									<td><?php echo $r -> NR_NOTA ?></td>
									<?php if($r -> NR_NOTA_EXTRA == '0'){ ?>
									<center><td>
										<div class="row">
											
												<form name="cadastro" method="POST" action="../componentes/indice-produtividade/logica/editar.php?
													sessionId=<?php echo $num ?>
													&operacao=extra
													&tipo=tb_produtividade
													&id=<?php echo $r->ID?>
													&servidor=<?php echo $r->CD_SERVIDOR ?>
													&mes=<?php echo $r -> NR_MES ?>
													&ano=<?php echo $r -> NR_ANO ?>
													&notaanterior=<?php echo $r -> NR_NOTA ?>" enctype="multipart/form-data">
														<div class="row">
															<div class="col-md-4">
									...
									<?php }else{ ?>
										...
										<td><center><?php echo $r -> NR_NOTA_EXTRA . " / " . $r -> NM_JUSTIFICATIVA_EXTRA ?></center></td>
