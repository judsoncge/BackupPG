<div class="row linha-modal-processo">
	<form method='POST' action='../componentes/despesa/logica/editar.php?sessionId=<?php echo $num ?>&operacao=mensagem&despesa=<?php echo $id ?>' enctype='multipart/form-data'>	
		<div class="col-md-10">
