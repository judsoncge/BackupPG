<div class='row linha-modal-processo'>
	<form method='POST' action='../componentes/processo/logica/editar.php?sessionId=<?php echo $num ?>&operacao=responsaveis&processo=<?php echo $numero_processo ?>' enctype='multipart/form-data'>	
		<div class="col-md-10">
			...
			<select multiple id="responsaveis" name="responsaveis[]" style="width: 96%;" required>
				<?php $lista3 = retorna_podem_ser_responsaveis($numero_processo, $conexao_com_banco);
