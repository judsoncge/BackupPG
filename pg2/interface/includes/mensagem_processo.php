<div class="row linha-modal-processo">
	<form method='POST' action='../componentes/processo/logica/editar.php?sessionId=<?php echo $num ?>&operacao=mensagem&processo=<?php echo $numero_processo ?>' enctype='multipart/form-data'>	
		<div class="col-md-10">
