<div class="row linha-modal-processo">
	<form method='POST' action='../componentes/chamado/logica/editar.php?sessionId=<?php echo $num ?>&operacao=mensagem&chamado=<?php echo $id ?>' enctype='multipart/form-data'>	
		<div class="col-md-10">
