...
<div class="caixa-alerta" id="caixa-alerta"></div>
	<!-- menu lateral -->
	<div id="wrapper">
		<!-- Sidebar -->
		<div id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<?php $permissao = retorna_permissao($_SESSION['CPF'],'VISUALIZAR_DOCUMENTO',$conexao_com_banco); if($permissao=='sim'){ ?>
						...
						<li class="sucor-subitem">
							<a href="documentos-criados.php?sessionId=<?php echo $num ?>"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Criados por mim</a>
						</li>
					
					<?php $permissao = retorna_permissao($_SESSION['CPF'],'VISUALIZAR_TODOS_SETOR_DOCUMENTO',$conexao_com_banco); if($permissao=='sim'){ ?>
						<li class="sucor-subitem">
							<a href="documentos-setor.php?sessionId=<?php echo $num ?>"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Setor</a>
						</li>
					<?php } ?>	
					...
					<?php $permissao = retorna_permissao($_SESSION['CPF'],'VISUALIZAR_TODOS_ORGAO_DOCUMENTO',$conexao_com_banco); if($permissao=='sim'){ ?>
						<li class="sucor-subitem">
							<a href="documentos-todos.php?sessionId=<?php echo $num ?>"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Todos</a>
						</li>
					<?php } ?>
				...
				<?php $permissao = retorna_permissao($_SESSION['CPF'],'VISUALIZAR_FINANCEIRO',$conexao_com_banco); if($permissao=='sim'){ ?>
					...
					<li class="financeiro-subitem">
						<a href="fluxo-caixa.php?sessionId=<?php echo $num ?>"><i class="fa fa-desktop icone-menu" aria-hidden="true"></i>Fluxo de caixa</a>
					</li>
					<li class="financeiro-subitem">
						<a href="bens-patrimoniais.php?sessionId=<?php echo $num ?>"><i class="fa fa-desktop icone-menu" aria-hidden="true"></i>Bens patrimoniais</a>
					</li>
					<li class="financeiro-subitem">
						<a href="despesas.php?sessionId=<?php echo $num ?>"><i class="fa fa-desktop icone-menu" aria-hidden="true"></i>Despesas</a>
					</li>	
					<li class="financeiro-subitem">
						<a href="receitas.php?sessionId=<?php echo $num ?>"><i class="fa fa-desktop icone-menu" aria-hidden="true"></i>Receitas</a>
					</li>						
				<?php } ?>
