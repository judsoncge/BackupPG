...
$lista = retorna_compra_processo($numero_processo, $conexao_com_banco);
...
if($lista != null){
	while($r = mysqli_fetch_object($lista)){ ?>
		<div class='row linha-modal-processo'>
			...
			<br>
			<?php if($r->NM_STATUS == 'Processo aberto'){ ?>
				<div class="col-md-12">
			...
			<br>
			<br>
			<?php if($r->NM_STATUS == 'Publicação no diário'){ ?>
				<div class="col-md-12">
			...
			<br>
			<br>
			<?php if($r->NM_STATUS == 'Termo de referência'){ ?>
				<div class="col-md-12">
			...
			<br>
			<br>
			<?php if($r->NM_STATUS == 'Cotação de preço 1'){ ?>
				<div class="col-md-12">
			...
			<br>
			<br>
			<?php if($r->NM_STATUS == 'Cotação de preço 2'){ ?>
				<div class="col-md-12">
			...
			<br>
			<br>
			<?php if($r->NM_STATUS == 'Cotação de preço 3'){ ?>
				<div class="col-md-12">
			...
			<br>
			<br>
			<?php if($r->NM_STATUS == 'Certidão negativa 1'){ ?>
				<div class="col-md-12">
			...
			<br>
			<br>
			<?php if($r->NM_STATUS == 'Certidão negativa 2'){ ?>
				<div class="col-md-12">
			...
			<br>
			<br>
			<?php if($r->NM_STATUS == 'Certidão negativa 3'){ ?>
