...
if($_GET['extra_assiduidade']==''){
	$extra_assiduidade = 0;
	
}else{
	$extra_assiduidade = $_GET['assiduidade'];
}

$nome_gerador_pdf = $_GET['nome_gerador'];
...
$html .= '
	...
	<div id="texto">
		<h3>Produtividade: '.$_GET['produtividade'].' (extra: '.$_GET['extra_produtividade'].')</h3>
		<table class="tg">
		  <tr>
		...
		<br>
		<h3>Assiduidade: '.$assiduidade.' (extra: '.$extra_assiduidade.')</h3>
		<table class="tg">
		  <tr>
		...
		<br>
		<h3>Cumprimento de Prazo: '.$_GET['cumprimento'].' (extra: '.$_GET['extra_cumprimento'].')</h3>
		<table class="tg">
		  <tr>
