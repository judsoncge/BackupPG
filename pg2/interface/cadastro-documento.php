...
<div id="page-content-wrapper">
	...
	<div class="container caixa-conteudo">
		<div class="row">
			<div class="col-lg-12">
				<div class="container">
					<form name="cadastro" method="POST" action="../componentes/documento/logica/cadastrar.php?sessionId=<?php echo $num ?>" 
					enctype="multipart/form-data"> <!-- login.php -->  
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input readonly class="form-control" id="numero_processo" value="<?php echo $_GET["processo"] ?>" 
									name="numero_processo" placeholder="Digite o número do processo" type="text"/>	
								</div>  
							</div>
							<?php }else{ ?>
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input readonly class="form-control" id="tipo_documento" value="<?php echo $_GET["tipo"] ?>" 
									name="tipo_documento" placeholder="Digite o número do processo" type="text" required/>	
								</div>  
							</div>
							<?php }else{ ?>
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input readonly class="form-control" id="atividade" value="<?php echo $_GET["descricao"] ?>" 
									name="tipo_atividade" placeholder="Digite o número do processo" type="text" required/>	
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input readonly class="form-control" id="interessado" value='<?php echo $_GET["interessado"] ?>' 
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input readonly class="form-control tipo-data" value='<?php echo $_GET["entrada"] ?>' 
							id="data_entrada" name="data_entrada" type="date" />	
						</div>  
					</div>
					<?php }else{ ?>
					<div class="col-md-4">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input <?php $prazo=$_GET["prazo"]; if($prazo!='0000-00-00'){ ?> readonly <?php }?>  
							class="form-control tipo-data" value='<?php echo $_GET["prazo"] ?>' id="prazo" name="prazo" type="date"/>	
						</div>  
					</div>
					<?php }else{ ?>
					<div class="col-md-4">
				...
				<?php if(isset($_GET["descricao"])){ ?>
					<div class="col-md-12">
						<div class="form-group">
							...
							<input readonly class="form-control" id="descricao_fato" name="descricao_fato" type="text" maxlength="300" 
							value='<?php echo $_GET["detalhes"] ?>' required/>
						</div>	
					</div>
				<?php }else{ ?>
					<div class="col-md-12">
