...
<div id="page-content-wrapper">
	<div class="container titulo-pagina">
		<p>Empresas que forneceram para o Estado de Alagoas em situação de inidoneidade, com registro no CEIS/BR</p>
		<p>Total: <?php echo retorna_quantidade_empresas_inidoneas_br($conexao_com_banco2)?> empresas</p>
	</div>
				...
				<div class="container">
					...
					<div class="col-md-12 table-responsive" style="overflow: auto; width: 100%; height: 300px;">
						<table class="table table-hover tabela-dados">
							...
							<tbody>
								<?php $lista = retorna_empresas_forneceram_ceisBR($conexao_com_banco2);
