					...
					<div class="well">
						...
						<div class="col-md-12 table-responsive" style="overflow: auto; width: 100%; height: 320px;">
							<table class="table table-hover tabela-dados">
								...
								<tbody>
									<?php $lista = retorna_documentos_setor($_SESSION['setor'],$conexao_com_banco);
										while($r = mysqli_fetch_object($lista)){ 
											...
											<tr>
												...
												<td>
												<?php $permissao = retorna_permissao($_SESSION['CPF'],'FAZER_OPERACOES_OUTROS_SETOR',$conexao_com_banco); if($permissao=='sim' or $r-> CD_SERVIDOR_LOCALIZACAO == $_SESSION['CPF']){ ?>
													<center>
												...
												<center>
													<?php $permissao = retorna_permissao($_SESSION['CPF'],'EDITAR_DOCUMENTO',$conexao_com_banco); $permissao2 = retorna_permissao($_SESSION['CPF'],'FAZER_OPERACOES_OUTROS_SETOR',$conexao_com_banco); if($permissao=='sim' and $permissao2=='sim'){ ?>
														<a href="edita-documento.php?sessionId=<?php echo $num ?>&documento=<?php echo $r -> CD_DOCUMENTO ?>&pagina=-setor"><button type='button' class='btn btn-secondary btn-sm' title="Editar"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
													<?php } ?>
													...
													<?php $permissao = retorna_permissao($_SESSION['CPF'],'EXCLUIR_DOCUMENTO',$conexao_com_banco); $permissao2 = retorna_permissao($_SESSION['CPF'],'FAZER_OPERACOES_OUTROS_SETOR',$conexao_com_banco); if($permissao=='sim' and $permissao2=='sim'){?>
														<a href="../componentes/documento/logica/excluir.php?sessionId=<?php echo $num ?>&documento=<?php echo $r -> CD_DOCUMENTO ?>&pagina=-setor"><button type='button' class='btn btn-secondary btn-sm' title="Excluir"><i class="fa fa-trash" aria-hidden="true"></i></button></a>
													<?php } ?>
