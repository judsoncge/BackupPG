...
<div id="page-content-wrapper">
	...
	<div class="container caixa-conteudo">
		<div class="row">
			<div class="col-lg-12">
				<div class="container">
					<form name="cadastro" method="POST" action="../componentes/processo/logica/editar.php?sessionId=<?php echo $num ?>&operacao=info&processo=<?php echo $id ?>&pagina=<?php echo $_GET['pagina'] ?>" enctype="multipart/form-data"> <!-- login.php -->  
						<div class="row">
							<div class="col-md-4">
