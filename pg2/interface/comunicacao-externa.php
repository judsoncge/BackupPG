...
<div id="page-content-wrapper">
	...
	<div class="container menu-home">
		<div class="btn-group" role="group" aria-label="...">
              ...
              <a href="comunicacao-externa.php?sessionId=<?php echo $num ?>"><button type="button" class="btn botao-comunicacao-ativo">Comunicação Externa</button></a>
    ...
    <div class="container caixa-conteudo">
        <?php $lista = retorna_comunicacao("Comunicação Externa", "Submetida", $conexao_com_banco);
          ...
          <div class="modal-header">
            ...
            <div class="modal-title">
                <center><p class="comunicacao-cabecalho"><?php echo $r-> NM_TITULO ?></p></center>
					<!--SLIDE-->
                      <ul class="rslides" >
					  <?php $lista3 = retorna_anexos($r->ID, $conexao_com_banco);
