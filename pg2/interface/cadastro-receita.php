...
<div class="container well">
	<div class="row">
		<div class="col-lg-12">
			<div class="container">
				<form name="cadastro" method="POST" action="../componentes/receita/logica/cadastrar.php?sessionId=<?php echo $num ?>&operacao=receita" enctype="multipart/form-data"> <!-- login.php -->  
					<div class="row">
						<div class="col-md-3">
