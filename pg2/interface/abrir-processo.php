		...
		<div class="row">
			<div class="col-lg-12">
				...
				<?php if(isset($_GET['documento'])){ ?>
					<form name="cadastro" method="POST" action="../componentes/processo/logica/cadastrar.php?sessionId=<?php echo $num ?>&documento=<?php echo $_GET['documento'] ?>" enctype="multipart/form-data"> <!-- login.php --> 
				<?php }else{ ?>
					<form name="cadastro" method="POST" action="../componentes/processo/logica/cadastrar.php?sessionId=<?php echo $num ?>" enctype="multipart/form-data"> <!-- login.php -->  
				<?php } ?>
