...
<div id="page-content-wrapper">
	...
	<div class="container caixa-conteudo">
		<div class="row">
			<div class="col-lg-12">
				<div class="container">
					<form name="cadastro" method="POST" action="../componentes/comunicacao/logica/editar.php?sessionId=<?php echo $num ?>&operacao=info&comunicacao=<?php echo $id ?>" enctype="multipart/form-data"> <!-- login.php -->  
                        <div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label" for="exampleInputEmail1">Texto do Item</label>
									 <textarea rows="10" cols="140" name="texto"><?php if($texto == null){ echo 'Sem texto';}else{ echo $texto;} ?></textarea>
								</div>  
                            </div>
						</div>
			...
			<div class="col-md-12 table-responsive" style="overflow: auto; width: 100%; height: auto; margin-top: 20px;">
                                    <table class="table table-hover tabela-dados">
                                        ...
                                        <tbody>    
                                            <?php $lista2 = retorna_anexos($id, $conexao_com_banco); while($r2 = mysqli_fetch_object($lista2)){ ?>
                                            <tr>
                                                <td><?php echo $r2 -> NM_ARQUIVO; ?> <b></td>
                                                <td><a href="../componentes/anexo/logica/excluir.php?id=<?php echo $r2 -> ID ?>&atual=<?php echo $r2 -> NM_ARQUIVO ?>&pasta=fotos-noticias"><button type='button' class='btn btn-secondary btn-sm' title="Excluir anexo"><i class="fa fa-trash" aria-hidden="true"></i></button></a></td>
                                            
                                            </tr>
											<?php } ?>
                                            <tr>
												<form name='teste' method='POST' action='../componentes/anexo/logica/cadastrar.php?documento=<?php echo $id ?>&pasta=fotos-noticias' enctype='multipart/form-data'>
