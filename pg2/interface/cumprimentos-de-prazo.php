...
<div id="page-content-wrapper">
	<div class="container titulo-pagina">
		<p>Todos os cumprimentos de prazo</p>
	</div>
				...
				<div class="container">
					...
					<div class="col-md-12 table-responsive" style="overflow: auto; width: 100%; height: 300px;">
						<table class="table table-hover tabela-dados">
							...
							<tbody>
									<?php $lista = retorna_cumprimentos_de_prazo($conexao_com_banco);
									...
									<tr>
										...
										<td><?php echo $r -> NR_PROCESSOS ?></td>
										<td><?php echo $r -> NR_PROCESSOS_CONCLUIDOS ?></td>
										<td><?php echo $r -> NR_PROCESSOS_CONCLUIDOS_ATRASO ?></td>
										...
										<?php $permissao = retorna_permissao($_SESSION['CPF'],'NOTA_EXTRA_INDICE_PRODUTIVIDADE',$conexao_com_banco); 
											if($r -> NR_NOTA_EXTRA == '0' and $permissao=='sim'){ ?>
												<td>
													<center>
														<form name="cadastro" method="POST" action="../componentes/indice-produtividade/logica/editar.php?sessionId=<?php echo $num ?>&operacao=extra&tipo=tb_cumprimento_prazo&id=<?php echo $r->ID?>&servidor=<?php echo $r->CD_SERVIDOR ?>&mes=<?php echo $r -> NR_MES ?>&ano=<?php echo $r -> NR_ANO ?>&notaanterior=<?php echo $r -> NR_NOTA ?>" enctype="multipart/form-data">
															<div class="row">
																<div class="col-md-4">
											...
											<?php }else{ ?>
												<td>
													<center>
														<?php echo $r -> NR_NOTA_EXTRA . " - Justificativa: " . $r -> NM_JUSTIFICATIVA_EXTRA ?>
													</center>
												</td>
											<?php } ?>
										</tr>
