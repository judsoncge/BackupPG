...
<div id="page-content-wrapper">
	...
	<div class="container menu-home">
		<div class="btn-group" role="group" aria-label="...">
              ...
              <a href="se-vira-nos-5.php"><button type="button" class="btn botao-comunicacao-ativo">Se vira nos 5</button></a>
              
	   </div>
	</div>   
    
    <div class="container caixa-conteudo">
        <?php $lista = retorna_comunicacoes_tipo("Se vira nos 5", "Submetida", $conexao_com_banco);
