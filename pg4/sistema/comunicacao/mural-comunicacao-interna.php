...
<div id="page-content-wrapper">
	...
	<div class="container menu-home">
		<div class="btn-group" role="group" aria-label="...">
              ...
              <a href="mural-comunicacao-interna.php"><button type="button" class="btn botao-comunicacao-ativo">Mural de Comunicação Interna</button></a>
    ...
    <div class="container caixa-conteudo">
        ...
        <?php $lista = retorna_comunicacoes_tipo("Mural de Comunicação Interna", "Submetida", $conexao_com_banco);
