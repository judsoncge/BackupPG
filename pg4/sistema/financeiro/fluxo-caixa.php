		...
		<div style="display: inline-block;">
		  ...
		  <div style="
			...
			height: 100%;">
				...
				<a  href="relatorio.php" class="btn btn-sm btn-info" style="vertical-align:;vertical-align: middle;"  download><i class="fa fa-list"></i> Baixar Relatório Sintético</a>
								...
								<tbody>
									...
									?>
										<tr style="display:none;" class="<?php echo str_replace(".","",$r->CD_DESPESA) ?>">
											<td class="despesa-abs"><?php echo $r2->DS_DESPESA;  ?></td>
