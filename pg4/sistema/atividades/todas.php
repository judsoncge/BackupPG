...
include('../head.php');
include('../body.php'); 
verificar_permissao_pagina($_SESSION['permissao-visualizar-todas-atividades'], $conexao_com_banco);
?>
				...
				<div class="container">
					<div class="well">
						<div class="row">
							...
							<?php if($_SESSION['permissao-cadastrar-atividade']=='sim'){ ?>
								<div class="col-sm-2 col-xs-12 pull-right">
									<!-- Somente algumas pessoas podem abrir um processo -->
									<a href="cadastrar.php" class="btn btn-sm btn-info pull-right"><i class="fa fa-plus-circle"></i> Atividade</a>
								</div>
							<?php } ?>
						</div>
					</div>
