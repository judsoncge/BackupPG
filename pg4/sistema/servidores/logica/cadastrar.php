...
//pegando a função digitado pelo usuario no cadastro
$novo_funcao = $_POST['funcao']; 

cadastrar_servidor($conexao_com_banco, $novo_cargo, $novo_funcao, $novo_setor,$novo_nivel,$novo_grupo,$novo_salario,$novo_nome, $novo_sobrenome , $novo_nomeacao,$novo_situacao_funcional,$novo_CPF, $novo_email_institucional ,$novo_matricula, $novo_cedido_por ,$novo_graduacao, $novo_senha);
