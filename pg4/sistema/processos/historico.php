<div class="row linha-modal-processo" style='max-height: 200px; overflow: auto;'>
	<div class="col-md-12">
		...
		while($r2 = mysqli_fetch_object($lista2)){ 
			...
			} else if($r2-> NM_ACAO == "Mensagem" or $r2-> NM_ACAO == "Líder" or $r2-> NM_ACAO == "Responsáveis" or $r2-> NM_ACAO == "Apensar" or $r2-> NM_ACAO == "Mudança de prazo"){
