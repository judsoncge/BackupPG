...
mysqli_query($conexao_com_banco, "UPDATE documento SET texto_documento='$edita_sugestao' WHERE id='$id' ") 
...
if($linha==1){         
	...
	VALUES ('$id_historico', '$id', 'EDITOU O TEXTO DO DOCUMENTO', '$pessoa', '$data_mensagem', 'Edição Resposta')") or die (mysqli_error($conexao_com_banco));
