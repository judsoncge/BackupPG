...
mes_competencia='$edita_competencia',  valor='$edita_valor', Veiculo_placa='$edita_placa', 
data_abastecimento='$edita_data_abastecimento' ,valor_litro='$edita_valor_litro', quantidade_litro='$edita_quantidade_litro'
WHERE numero_empenho='$empenho' ") 
