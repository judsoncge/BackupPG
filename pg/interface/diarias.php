		...
		<div class="row">
			<div class="col-lg-12">
				<div class="container">
					<div class="well">
						<div class="row">
							...
							<div class="col-sm-2 col-xs-12 pull-right">
								<a href="cadastro-diaria.php?sessionId=<?php echo $num ?>" class="btn btn-sm btn-info pull-right"><i class="fa fa-plus-circle"></i> Nova diária</a>
							</div>
						</div>
					</div>
					...
					<tbody>
								<?php $lista = retorna_dados("diaria", $conexao_com_banco);
								...
								<tr>
									...
									<td><?php echo arruma_numero($r -> valor) ?></td>
								...
								<div class='modal-dialog modal-lg'>
									<div class='modal-content'>
										<div class='modal-header'>
											...
											<h4 class='modal-title' id='myModalLabel'> Diária de <?php echo $beneficiario2 ?> para <?php echo $r -> destino?></h4>
										</div>
										<div class='modal-body'>
											...
											<div class="row">
												<div class="col-md-6">
													<label class="control-label" for="exampleInputEmail1">Número da portaria: <b><?php echo $r -> numero_portaria ?></b></label>
												</div>
												<div class="col-md-6">
													<label class="control-label" for="exampleInputEmail1">Data da publicação da portaria: <b><?php echo arruma_data($r -> data_publicacao_portaria) ?></b></label>
												</div>
											</div>
											<div class="row">
												<div class="col-md-6">
													<label class="control-label" for="exampleInputEmail1">Destino: <b><?php echo $r -> destino ?></b></label>
												</div>
												<div class="col-md-6">
											...
											<div class="row">
												...
												<div class="col-md-6">
													<label class="control-label" for="exampleInputEmail1">Número de diárias: <b><?php echo $r -> numero_diarias ?></b></label>
												</div>
												
											</div>
											<div class="row">
											<div class="col-md-6">
													<label class="control-label" for="exampleInputEmail1">Valor total: <b>R$<?php echo arruma_numero($r -> valor) ?></b></label>
											</div>
											</div>
											</div>
										<div class='modal-footer'>
											...
											<div class="row">
												...
												<div class="col-md-6">
														<a href='edita-diaria.php?sessionId=<?php echo $num ?>&diaria=<?php echo $r->id ?>' name='submit' value='Send' id='btn-editar'><button type='submit' class='btn btn-sm btn-default btn-block pull-right' name='submit' value='Send' id='btn-editar'>Editar diária &nbsp;&nbsp;<i class='fa fa-pencil-square' aria-hidden='true'></i></button></a>
												</div>	
												<div class="col-md-6">
														<a href='../componentes/diaria/logica/excluir.php?id=<?php echo $r -> id ?>' name='submit' value='Send' id='btn-editar'><button type='submit' class='btn btn-sm btn-default btn-block pull-right' name='submit' value='Send' id='btn-editar'>Excluir diária &nbsp;&nbsp;<i class='fa fa-pencil-square' aria-hidden='true'></i></button></a>
												</div>	
