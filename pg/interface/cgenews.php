...
<div id="page-content-wrapper">
	...
	<div class="container menu-home">
		<div class="btn-group" role="group" aria-label="...">
              ...
              <a href="cgenews.php?sessionId=<?php echo $num ?>"><button type="button" class="btn botao-comunicacao-ativo">CGE News</button></a>
    ...
    <div class="container caixa-conteudo">
        ...
        <?php $lista = retorna_comunicacao("CGE News", "Submetida", $conexao_com_banco);
