							...
							<div class="row">
								...
								<div class='col-md-3'>
									<div class='box-equipe'>
										<img src='../registros/fotos/<?php echo retorna_foto_pessoa('277.246.974-34', $conexao_com_banco) ?>' class='equipe-img'>
									</div>
                                ...
                                <div class='col-md-3'>
									<div class='box-equipe'>
										<img src='../registros/fotos/<?php echo retorna_foto_pessoa('057.996.054-46', $conexao_com_banco) ?>' class='equipe-img'>
									</div>
									<div class='equipe_servidor'><b>Thiago Paiva</b><br>Coordenador</div>
								</div>
    							<div class='col-md-3'>
									<div class='box-equipe'>
										<img src='../registros/fotos/<?php echo retorna_foto_pessoa('090.168.524-09', $conexao_com_banco) ?>' class='equipe-img'>
									</div>
									<div class='equipe_servidor'><b>Denys Rocha</b><br>Desenvolvedor</div>
								</div>
    							<div class='col-md-3'>
									<div class='box-equipe'>
										<img src='../registros/fotos/<?php echo retorna_foto_pessoa('062.200.904-46', $conexao_com_banco) ?>' class='equipe-img'>
									</div>
