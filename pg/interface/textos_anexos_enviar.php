...
<div class='row'>
															...
															$existe_processo = verifica_processos_documento($id, $conexao_com_banco);
...
<?php } else{
	...
	echo 'Este documento está atrelado ao processo '.$existe_processo.' . Tramite-o para que este documento vá junto.';
