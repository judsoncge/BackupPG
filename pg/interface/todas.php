...
<div id="page-content-wrapper">
	...
	<div class="container menu-home">
		<div class="btn-group" role="group" aria-label="...">
              <a href="todas.php?sessionId=<?php echo $num ?>"><button type="button" class="btn botao-comunicacao-ativo">Todas</button></a>
    ...
    <div class="container caixa-conteudo">
        <?php $lista = retorna_comunicacao_todas('Submetida',$conexao_com_banco);
    ...
    <?php if($r -> item == 'Comunicação Externa' or $r -> item == 'Rede Social' or $r -> item == 'Se vira nos 5'){ ?>
    <!-- Modal -->
