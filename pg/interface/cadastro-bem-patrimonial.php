...
<div id="page-content-wrapper">
	...
	<div class="container caixa-conteudo">
		<div class="row">
			<div class="col-lg-12">
				<div class="container">
					<form name="cadastro" method="POST" action="../componentes/bem-patrimonial/logica/cadastrar.php" enctype="multipart/form-data"> <!-- login.php -->  
						<div class="row">
							<div class="col-md-3">
								...
								<div class="form-group">
									<label class="control-label" for="exampleInputEmail1">Denominação</label>
										<select class="form-control" id="denominacao" name="denominacao" required/>
											...
											while($r = mysqli_fetch_object($lista)){ ?>
											<option value="<?php echo $r->classificacao_contabil ?>"><?php echo $r->denominacao ?></option><?php } ?>
										</select>
								</div>  
							</div>
				</div>
