...
<head>
	...
	<!--<?php require("richtexteditorphp/richtexteditor/include_rte.php") ?> -->

	<!-- script de máscaras -->

	<!-- script para múltiplos filtros. o resto está no footer.php -->
	...
	calcula_cumprimento_prazo($conexao_com_banco);
	calcula_produtividade($conexao_com_banco);
	grava_nota_geral($conexao_com_banco); 
	?>
	...
	<?php include('../componentes/banco-dados/conectar.php'); ?>
</head>