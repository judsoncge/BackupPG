  ...
  <div class="container caixa-conteudo">
    ...
    <div class="row linha-grafico">
      ...
      <div class="col-md-6">
		...
		Processos <b>sem prazo parcial ou final</b> no órgão: <?php echo retorna_numero_processos_sem_prazo($conexao_com_banco) ?> <br><br>
		Por setor: <br><br>
			<?php 
			$lista = retorna_setores($conexao_com_banco);
			while($r = mysqli_fetch_object($lista)){
				echo $r->NM_SETOR. "</b>: ". retorna_numero_processos_setor_sem_prazo($r->CD_SETOR,$conexao_com_banco) . "<br>"; 
			} 
			?>
		</div>
      </div>
