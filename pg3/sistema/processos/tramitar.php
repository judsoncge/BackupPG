<form name='teste' method='POST' action='logica/editar.php?operacao=tramitar&processo=<?php echo $informacoes['CD_PROCESSO'] ?>&prazo=<?php echo $informacoes['DT_PRAZO'] ?>&prazo_final=<?php echo $informacoes['DT_PRAZO_FINAL'] ?>' enctype='multipart/form-data'>	
