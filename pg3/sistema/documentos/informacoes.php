<div class="row linha-modal-processo" style="padding-left: 25px;">
		<label class='control-label' id='solicitante'><b>Tipo de atividade:</b> <?php echo $informacoes['NM_ATIVIDADE'] ?></label><br>
		...
		<label class='control-label' id='data_abertura'><b>Número do processo: </b><a href='../processos/detalhes.php?processo=<?php echo $informacoes['CD_PROCESSO'] ?>'><?php echo $informacoes['CD_PROCESSO'] ?></a></label><br>
