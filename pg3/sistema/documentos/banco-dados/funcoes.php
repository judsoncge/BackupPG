...
function editar_documento($conexao_com_banco, $id_documento, $processo, $tipo_atividade, $tipo_documento, $interessado, $data_entrada, $prazo, $prioridade, $descricao_fato, $texto_documento, $valor){
	...
	mysqli_query($conexao_com_banco, "UPDATE tb_documentos SET CD_PROCESSO='$processo', NM_ATIVIDADE='$tipo_atividade', NM_DOCUMENTO='$tipo_documento', NM_INTERESSADO='$interessado', DT_ENTRADA='$data_entrada', DT_PRAZO='$prazo', NR_PRIORIDADE='$prioridade', DS_DOCUMENTO='$descricao_fato', TX_DOCUMENTO='$texto_documento', VLR_DOCUMENTO='$valor' WHERE CD_DOCUMENTO='$id_documento'") 
