...
<div id="page-content-wrapper">
	...
	<div class="container menu-home">
		<div class="btn-group" role="group" aria-label="...">
              ...
              <a href="rede-social.php"><button type="button" class="btn botao-comunicacao-ativo">Rede Social</button></a>
    ...
    <div class="container caixa-conteudo">
        ...
        <?php $lista = retorna_comunicacoes_tipo("Rede Social", "Submetida", $conexao_com_banco);
