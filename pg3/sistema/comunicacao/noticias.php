  ...
  <div id="natal3"></div>
	...
	<div class="container menu-home">
		<div class="btn-group" role="group" aria-label="...">
              <a href="home.php"><button type="button" class="btn botao-comunicacao-ativo">Todas</button></a>
    ...
    <div class="container caixa-conteudo">
        ...
        while($r = mysqli_fetch_object($lista)){ $id=$r -> CD_COMUNICACAO;?>
        <div class="col-md-4">
		<?php 
			
			$lista2 = retorna_anexos_comunicacao($id,$conexao_com_banco);
