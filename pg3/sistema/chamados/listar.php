								...
								<tr>
								   ...
								   <td><center><a href='detalhes.php?chamado=<?php echo $r -> CD_CHAMADO ?>'>
									...
									<?php if($_SESSION['permissao-excluir-chamado']=='sim'){ ?>
										<td><center>
											<a href='logica/excluir.php?chamado=<?php echo $id ?>'onclick="return confirm('Você tem certeza que deseja apagar este chamado?');"><button type='button' class='btn btn-secondary btn-sm' 
