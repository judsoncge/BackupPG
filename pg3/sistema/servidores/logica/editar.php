...
if($_GET['operacao']=='info'){
	...
	editar_servidor($conexao_com_banco, $CPF_atual ,$edita_cargo, $edita_setor,$edita_nivel,$edita_grupo,$edita_salario,$edita_nome, $edita_sobrenome , $edita_nomeacao,$edita_situacao_funcional, $edita_CPF, $edita_email_institucional ,$edita_matricula, $edita_cedido_por ,$edita_graduacao);
